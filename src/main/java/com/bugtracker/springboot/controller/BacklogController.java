...
public class BacklogController {
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTasks projectTask, BindingResult result,
        ...
        ProjectTasks updatedTask = projectTaskService.updateByProjectSequence(projectTask,backlog_id,pt_id);

        return new ResponseEntity<ProjectTasks>(updatedTask,HttpStatus.OK);
